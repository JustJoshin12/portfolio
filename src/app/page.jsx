...
import logoRedLobster from '@/images/logos/red-lobster.svg'
import logoTripleTen from '@/images/logos/triple-ten.svg'
import logoUdemy from '@/images/logos/udemy.svg'
import logoOliveGarden from '@/images/logos/olive-garden.svg'
...
function Role({ role }) {
  ...
  return (
    <li className="hover:dd:text-slate-100 flex gap-4 rounded p-2 duration-200 hover:bg-zinc-500 dark:hover:bg-zinc-100/20">
      ...
      <dl className="flex flex-auto flex-wrap gap-x-2">
        ...
        <dd className="text-xs text-zinc-900 dark:text-zinc-400">
          {role.title}
        </dd>
    ...
    <>
      ...
      <Container className="mt-24 md:mt-28">
        <div className="mx-auto grid max-w-xl grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="mt-2 space-y-10 lg:pl-16 xl:pl-24">
            <Resume />
          </div>
        </div>
      </Container>
